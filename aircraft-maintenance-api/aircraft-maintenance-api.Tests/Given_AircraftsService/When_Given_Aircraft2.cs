...
namespace Aircraft.Maintenance.Core.Tests.Given_AircraftsService
{
    public class When_Given_Aircraft2
    {
        ...
        private readonly int fakeAircraftId = 2;
        ...
        private readonly Tuple<int, IEnumerable<AircraftTask>> expected =
            new Tuple<int, IEnumerable<AircraftTask>>(2, new List<AircraftTask>
            {
                new AircraftTask
                {
                    ItemNumber = 4,
                ...
                {
                    ItemNumber = 3,
                    NextDue = DateTime.Parse("04/07/2019")
                },
                new AircraftTask
                {
                    ItemNumber = 2,
                    NextDue = DateTime.Parse("05/03/2019")
                },
                new AircraftTask
                {
                    ItemNumber = 1,
